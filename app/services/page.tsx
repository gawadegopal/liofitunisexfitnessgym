...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.liofitunisexfitnessgym.space/services" },
  keywords: [
...
export default function ServicesPage() {
  const schemaData = {
    ...
    provider: { "@type": "HealthClub", name: "Lio-Fit Unisex Fitness Gym", url: "https://www.liofitunisexfitnessgym.space/services" },
